...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:sidebar sticky collapsible class="bg-zinc-50 dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-700">
        ...
        <flux:sidebar.nav>
            ...
            {{-- DOMINIO: ADMINISTRACIÓN / SEGURIDAD --}}
            <flux:sidebar.group expandable icon="cog-6-tooth" heading="Administración / Seguridad" class="grid">
                <flux:sidebar.item icon="shield-check" href="#" {{-- Cambia por tu ruta real
                    --}} :current="request()->routeIs('usuarios.*')">
                    Usuarios
                </flux:sidebar.item>

                {{-- Comentado para el futuro cuando lo hagas administrable en BD --}}
                {{--
