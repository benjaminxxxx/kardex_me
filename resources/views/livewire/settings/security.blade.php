<section class="w-full">
    ...
    <x-settings.layout heading="Actualizar contraseña"
        subheading="Asegúrate de que tu cuenta utilice una contraseña larga y aleatoria para mantenerla segura.">
        ...
        @if ($canManageTwoFactor)
            <section class="mt-12">
                ...
                <flux:subheading>Administra la configuración de la autenticación de dos factores.</flux:subheading>

                <div class="flex flex-col w-full mx-auto space-y-6 text-sm" wire:cloak>
                    @if ($twoFactorEnabled)
                        <div class="space-y-4">
                            <flux:text>
                                Durante el inicio de sesión se te solicitará un código PIN seguro y aleatorio, el cual podrás
                                obtener desde una aplicación compatible con TOTP instalada en tu teléfono.
                            </flux:text>
                    ...
                    @else
                        <div class="space-y-4">
                            <flux:text variant="subtle">
                                Al activar la autenticación de dos factores, durante el inicio de sesión se te solicitará un
                                código PIN seguro. Este código podrás obtenerlo desde una aplicación compatible con TOTP
        ...
        @if ($canManagePasskeys)
            <section class="mt-12">
                ...
                <flux:subheading>Administra tus claves de acceso para iniciar sesión sin contraseña.</flux:subheading>
    ...
    <flux:modal name="delete-passkey-modal" class="max-w-md md:min-w-md" @close="closeDeleteModal"
        ...
        <div class="space-y-6">
            <div class="space-y-2">
                ...
                <flux:text>
                    ¿Estás seguro de que deseas eliminar la clave de acceso "{{ $deletingPasskeyName }}"? Ya no podrás
                    utilizarla para iniciar sesión.
                </flux:text>
            </div>
